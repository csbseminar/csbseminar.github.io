        ...
        <main className="space-y-12">
          ...
          <div className="grid gap-12 md:grid-cols-2">
            <section className="border p-6">
              ...
              <div className="space-y-4">
                <Button className="w-full" asChild>
                  <a href="https://weizmann.zoom.us/j/99099764127?pwd=1o8uu2STrFde7Lqx5YFPDuyWThCHBl.1" target="_blank" rel="noopener noreferrer">
            ...
            <section className="border p-6">
              ...
              <div className="space-y-4">
                <Button className="w-full" asChild>
                  <a href="https://groups.google.com/g/comp-spatial-biology" target="_blank" rel="noopener noreferrer">
